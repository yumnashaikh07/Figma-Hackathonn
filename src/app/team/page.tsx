  ...
  return (
    <main className="mx-auto">
      ...
      <section className="bg-white flex flex-col text-center py-16 md:py-9">
        ...
        <h1 className="text-[#252B42] font-bold text-5xl">
      ...
      <section className="flex flex-col text-center md:p-32">
        <h1 className="text-[#252B42] md:p-0 p-20 text-4xl font-bold ">
          Meet Our Team
        </h1>
        ...
        <section className="md:flex md:justify-between grid grid-cols-1 md:space-x-5 md:p-20">
          <div className="md:text-center">
            ...
            <div className="flex gap-x-3 ml-40 md:ml-[90px] md:mb-0 mb-5 mt-2">
        ...
        <section className="md:flex md:justify-between grid grid-cols-1  md:space-x-5 md:p-20">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold mt-7">Username</h3>
            <h3 className="text-gray-500 font-semibold mt-2">Profession</h3>
            <div className="flex gap-x-3 ml-40 md:ml-[90px] mt-2">
              <FaFacebook className="text-blue-500" size={24} />
              <FaInstagram
                className="md:text-blue-500 text-[#E51F5A]"
                size={24}
