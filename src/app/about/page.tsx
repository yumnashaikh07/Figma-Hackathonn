    ...
    <main className="mx-auto">
      ...
      <section className="md:ml-32 grid md:grid-cols-2 grid-cols-1">
        <div className="md:mt-32 text-center md:text-left md:py-0 py-32">
          <h5 className="text-sm hidden md:flex font-bold mb-11">
            ABOUT COMPANY
          </h5>
          ...
          <Button className="  py-5 rounded-sm bg-[#23A6F0] text-white">
            <Link href={"/"}>Get Quote Now</Link>
          </Button>
        </div>
        <Image src={"/abouttop.png"} height={429} width={600} alt="" />
      </section>

      <section className="grid grid-cols-1 md:grid-cols-2">
        <div className=" md:ml-40 text-center md:text-left md:py-0 py-32 md:mt-16">
          <h5 className="text-red-500 mb-5 font-bold text-sm">
            Problems trying
          </h5>
        ...
        <div className="text-gray-500 font-semibold md:mt-28 md:px-0 px-7 md:mr-44 ">
          <h3>
            ...
            of Classical physics: Newtonisan mechanics
          </h3>
        </div>
      </section>
      ...
      <section className="grid md:grid-cols-4 grid-cols-1 p-20 md:mt-16 mt-11 text-center md:mx-24">
        <div>
          ...
          <p className="text-gray-500 mt-3 font-semibold">Happy Customers</p>
        </div>
        <div>
          <h1 className="text-6xl md:mt-0 mt-24 font-bold">150K</h1>
          <p className="text-gray-500 mt-3 ml-3 font-semibold">
            Monthly Visitors
          </p>
        </div>
        <div>
          <h1 className="text-6xl  md:mt-0 mt-24 font-bold">15</h1>
          <p className="text-gray-500 mt-3 font-semibold">
            Countries Worldwide
          </p>
        </div>
        <div>
          <h1 className="text-6xl md:mt-0 mt-24 font-bold">100+</h1>
          <p className="text-gray-500 mt-3  font-semibold">Top Partners</p>
        </div>
      </section>
      ...
      <section className="relative mx-auto">
        <Image
          ...
          height={790}
          alt=""
          className="md:ml-16 md:w-[1150px] w-[635px] h-[316px] md:h-auto"
        />
        <Button className="bg-blue-500 rounded-full md:px-[30px] px-3 py-1 md:py-9 text-white absolute top-1/2 left-1/2 ml-[1px] md:ml-[9px] transform -translate-x-1/2 -translate-y-1/2">
          <FaPlay size={1} />
        </Button>
      </section>
      ...
      <div className="flex flex-col justify-center text-center">
        ...
        <h3 className="text-sm text-gray-500 font-semibold mb-32">
      ...
      <section className=" w-full bg-[#2A7CC7] flex justify-between">
        <div className=" text-white py-16 md:py-0 md:px-0 px-16 md:mt-36 md:ml-44 ">
          ...
          <p className=" mb-7 md:text-left text-center">
            small-scale behaviour during the first quarter of 20th
          </p>
          <Button className="bg-[#2A7CC7] md:ml-0 ml-[67px] border-2 px-10 text-lg rounded-sm py-6 border-white">
            Button
          </Button>
        </div>
        <Image
