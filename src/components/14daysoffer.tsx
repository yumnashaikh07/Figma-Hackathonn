  ...
  return (
    <main className="mx-auto">
      <section className="flex flex-col md:mx-auto mx-12 text-center py-32">
        <h1 className="text-4xl text-[#252B42] font-bold mt-14 ">
          Start your 14 days free trail
        </h1>
        <p className="mt-3 text-[#737373]">
          Met minim Mollie non desert Alamo est sit cliquey dolor{" "}
        </p>
        <p className="mb-11 text-[#737373]">
          do met sent. RELIT official consequent.
        </p>
        <Button className="text-white md:ml-[550px] ml-24 px-16 bg-[#23A6F0] w-[106px] h-[22px] py-5 rounded-sm">
          Try it free now
        </Button>
